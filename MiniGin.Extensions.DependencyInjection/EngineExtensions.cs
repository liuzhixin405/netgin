namespace MiniGin.Extensions.DependencyInjection;
...
{
    private static readonly string ServicesKey = "__MiniGin_Services__";
    private static readonly string ServiceProviderKey = "__MiniGin_ServiceProvider__";
